    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-6 c-footer-right">
                <a href="https://instagram.com/mcsmart.app" target="_blank" style="text-decoration: none;" >
                ...
                @if (Browser::isDesktop())
                    <a href="https://facebook.com/McSmartApp" target="_blank" rel="noopener noreferrer" style="text-decoration: none;">
                        <img class="mr-2" src="{{url('/assets/images/facebook.png')}}" alt="facebook logo">
                    </a>
                @endif
